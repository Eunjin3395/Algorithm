...
# 1번 선수는 4번 타자로 지정하고 나머지 선수 순서 조합 결정
# player_order = []
# for perm in permutations(range(0, 9), 9):
#     if perm[3] == 0:
#         player_order.append(perm)
...
def hit_ball(n):
    ...
    if type[n] == 1:
        ...
        return True
    # print("-- hit player:", n, " before score:", before, ", after score:", score)
    return False

answer = 0
# player_order = [(1, 2, 3, 0, 4, 5, 6, 7, 8), (2, 3, 4, 0, 1, 5, 6, 7, 8)]
