...
SELECT 
    BIT_OR(CASE WHEN CATEGORY = 'Front End' THEN CODE ELSE 0 END) AS FE,
    BIT_OR(CASE WHEN NAME = 'Python' THEN CODE ELSE 0 END) AS PY,
    BIT_OR(CASE WHEN NAME = 'C#' THEN CODE ELSE 0 END) AS CS
FROM SKILLCODES
)
